...
module.exports.loop = function () {
	profiler.wrap(() => {
		...
		if (Object.keys(Game.creeps).length <= 4) {
			...
			//domestic types
			if (roleHarvester.spawn('Spawn1', 10, 'large', null, null) != OK)
			if (roleUpgrader.spawn('Spawn1', 4, 'large', 0, 1) != OK)
			if (roleRepairer.spawn('Spawn1', 10, 'medium', null, null) != OK)
			if (roleBuilder.spawn('Spawn1', 10, 'large', null, null) != OK)
